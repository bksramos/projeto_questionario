            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><i class="fa fa-file-text-o"></i>Editar Avaliação</li>
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Edição da avaliação do documento "{{$relations->pivotParent->title}}"
                        </header>
                        <div class="container">
                            <div class="row">
                                <div class="col-xs-8">
                                    <div class="card">
                                        ...
                                        <form action="/update/{{$documento->id}}-{{ Str::slug($documento->title)}}" method="post">
                                            @csrf
